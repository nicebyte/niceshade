...
cross_compiler::cross_compiler(shader_kind kind,
...
void cross_compiler::add_cis_to_map(separate_to_combined_map &image_map,
...
void cross_compiler::add_resources_to_pipeline_layout(pipeline_layout& layout) const {
...
void cross_compiler::compile(const std::string &out_file_path) {
  const std::string full_out_file_path =
    out_file_path + 
    (kind() == shader_kind::vertex ? ".vs." : ".ps.") +
